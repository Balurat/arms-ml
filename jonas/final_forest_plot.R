...
plot_forest_all <- function(
  ...
  stopifnot(
    inherits(m_all,    "coxph") | 
    inherits(m_male,   "coxph") | 
    inherits(m_female, "coxph") 
  )
  
  # get df for every model and data
...
prepare_df <- function(model, data, group) {
